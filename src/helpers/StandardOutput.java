...
/**
 * Class Name: StandardOutput This class prints to the standard output
 */
public class StandardOutput {
  /**
   * Print out output, and calls printErrors to print out error messages.
   *
   * @param output String to send to stdOut
   */
